...
import { ArrowLeft, CheckCircle, Play, Lock, Shield, Heart, Car, Home } from "lucide-react";
  ...
  const lessons = [
    {
      ...
      description: "Understanding the importance of financial protection",
      duration: "6 min",
      content: {
        summary: "Learn why insurance is crucial for financial security and peace of mind.",
        keyPoints: [
          "Insurance protects against unexpected financial losses",
          "Reduces financial burden during emergencies", 
          "Provides security for your family's future",
    ...
    },
    {
      ...
      description: "Exploring different insurance categories",
      duration: "8 min", 
      content: {
        summary: "Understand various insurance types and their specific purposes.",
        keyPoints: [
    ...
    },
    {
      ...
      description: "How to select appropriate insurance amounts",
      duration: "7 min",
      content: {
        summary: "Learn to determine optimal coverage based on your needs and budget.",
        keyPoints: [
          "Assess your current financial obligations",
          "Calculate replacement income needs",
          "Consider inflation and future expenses",
          "Balance premium costs with coverage benefits"
        ]
      }
    }
  ];
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-foreground">Insurance Planning</h1>
            <p className="text-sm text-muted-foreground">Protect your finances</p>
          </div>
        </div>
          ...
          {progressPercentage === 100 && (
            <Card className="p-6 bg-gradient-success text-secondary-foreground">
              <div className="text-center">
                ...
                <h3 className="font-bold mb-2">Course Completed! 🛡️</h3>
                <p className="text-sm opacity-90 mb-4">
                  You've mastered Insurance Planning. Ready for the next level?
                </p>
                <Button 
                  variant="secondary" 
