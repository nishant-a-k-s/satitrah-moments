  ...
  const lessons = [
    {
      ...
      description: "Understanding the difference between money coming in and going out",
      duration: "5 min",
      content: {
        summary: "Learn to differentiate between income sources and expense categories.",
        keyPoints: [
          "Income: Money you earn from salary, business, investments",
          "Expenses: Money you spend on needs and wants",
          "Net Income = Total Income - Total Expenses",
          "Track both to understand your financial health"
        ]
      }
    },
    {
      id: 2,
      title: "Savings Mindset",
      description: "Developing the habit of saving money regularly",
      duration: "7 min",
      content: {
        summary: "Build a strong foundation for financial growth through consistent saving.",
        keyPoints: [
          "Pay Yourself First: Save before spending",
          "Start small: Even ₹100/day = ₹36,500/year",
    ...
    },
    {
      ...
      duration: "6 min",
      content: {
        summary: "Create a buffer to protect yourself from financial emergencies.",
        keyPoints: [
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold text-foreground">Financial Basics</h1>
            ...
            <Card className="p-6 bg-gradient-success text-secondary-foreground">
              <div className="text-center">
                ...
                <p className="text-sm opacity-90 mb-4">
                  You've mastered Financial Basics. Ready for the next level?
                </p>
                <Button 
                  variant="secondary" 
                  onClick={() => navigate('/smart-budgeting')}
                >
                  Continue to Smart Budgeting
                </Button>
              </div>
            </Card>
          )}
